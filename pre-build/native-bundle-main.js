(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK 0.23.8, Build 2018-01-11 15:37.');
;(this.getJSFMVersion = function(){return "0.23.8"});
...
var subversion = {"framework":"0.23.8","transformer":">=0.1.5 <0.5"};
  ...
  services.forEach(function (ref) {
    ...
    if (create) {
      try {
        ...
        console.log(("[JS Runtime] Failed to create service " + name + "."));
      }
    }
  });
